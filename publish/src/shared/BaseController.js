...
var _class = function (_Controller) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.SSR = true, _this.preload = {
      ...
      UPDATE_LOADING_TEXT("");
    }, _this.NeedLogin = false, _temp), _possibleConstructorReturn(_this, _ret);
  } // 开启服务端渲染
  ...
  _createClass(_class, [{
    ...
    key: "fetch",
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(url, options) {
        var data, success, error_msg, userInfo;
